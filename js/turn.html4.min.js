    ...
    i = {
      init: function (a) {
        ...
        var e,
          ...
          g = this.data(),
          c = this.children(),
          a = f.extend({ width: this.width(), height: this.height(), direction: this.attr("dir") || this.css("direction") || "ltr" }, z, a);
        g.opts = a;
        g.pageObjs = {};
        g.pages = {};
        g.pageWrap = {};
        ...
        if (c)
          if (i._necessPage.call(this, a)) {
            if (!b.pageWrap[a]) {
              ...
              b.pagePlace[a] = a;
              b.pageWrap[a] = f("<div/>", { class: "turn-page-wrapper", page: a, css: { position: "absolute", overflow: "hidden" } }).css(
                d
              );
      ...
      page: function (a) {
        ...
        return 0 < a && a <= b.totalPages
          ? (!b.done || -1 != f.inArray(a, this.turn("view")) ? i._fitPage.call(this, a) : i._turnPage.call(this, a), this)
          : b.page;
      },
      next: function () {
      ...
      update: function () {
        ...
        if (b.pageMv.length && 0 !== b.pageMv[0]) {
          ...
          for (a in b.pageWrap)
            j(a, b.pageWrap) &&
              ((d = i._setPageLoc.call(this, a)), b.pages[a] && b.pages[a].flip("disable", b.disabled || 1 != d).flip("z", null));
      },
          ...
          if (((a = [a]), b.corner)) {
            ...
            !this.data().effect &&
              ...
              ((a = h._cornerActivated.call(this, a[0]))
                ? ((b = h._c.call(this, a.corner, b.opts.cornerSize / 2)), (a.x = b.x), (a.y = b.y), h._showFoldedPage.call(this, a, !0))
