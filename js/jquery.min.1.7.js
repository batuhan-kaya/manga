    ...
    (f.Event = function (a, b) {
      ...
      a && a.type
        ? ((this.originalEvent = a),
          (this.type = a.type),
          (this.isDefaultPrevented = a.defaultPrevented || a.returnValue === !1 || (a.getPreventDefault && a.getPreventDefault()) ? N : M))
        : (this.type = a),
        b && f.extend(this, b),
      ...
      ajax: function (a, c) {
        ...
        h.promise(v),
          ...
          d.crossDomain == null &&
            ...
            (d.crossDomain = !(
              !r ||
              (r[1] == bY[1] && r[2] == bY[2] && (r[3] || (r[1] === "http:" ? 80 : 443)) == (bY[3] || (bY[1] === "http:" ? 80 : 443)))
            ))),
  ...
  f.ajaxSetup({
    ...
    f.ajaxPrefilter("json jsonp", function (b, c, d) {
      ...
      if (b.dataTypes[0] === "jsonp" || (b.jsonp !== !1 && (cg.test(b.url) || (e && cg.test(b.data))))) {
        ...
        b.jsonp !== !1 &&
          ((j = j.replace(cg, l)),
          b.url === j && (e && (k = k.replace(cg, l)), b.data === k && (j += (/\?/.test(j) ? "&" : "?") + b.jsonp + "=" + h))),
          (b.url = j),
          (b.data = k),
          (a[h] = function (a) {
            g = [a];
